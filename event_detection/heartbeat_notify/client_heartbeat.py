...
PATH_ENV_HB_SERVER = ".env-heartbeat-client"
ENV_HB = dotenv_values(PATH_ENV_HB_SERVER)
DEVICE_ID = ENV_HB.get("DEVICE_ID", "unknown")
AUTH_TOKEN = ENV_HB["TOKEN"]
SERVER_ENDPOINT = ENV_HB["SERVER_ENDPOINT"]
HEARTBEAT_SEC = int(ENV_HB.get("HEARTBEAT_SEC", 10))
RETRY_SEC = int(ENV_HB.get("RETRY_SEC", 5))
